...
**Latest Vue 3 release:** `3.1.5` for Vue `3.x`
...
The current stable Vue 3 release is `3.1.5`. It preserves the renderless and state composables, scoped-slot customization, helper APIs, and combobox contract while refreshing the tested Vue runtime and security-sensitive development toolchain without changing the public API.
...
| :---: | :---: | :---: | :---: | :--- |
| **3.x** | **Vue 3 only** | **`>=3.0.0 <4.0.0`** | **3.1.5 through 3.5.41** | [Vue 3 family docs](https://alexandro.net/docs/vue/multiselect/vue-3/) |
...
The `3.1.x` line enforces the interaction details that usually matter most in production forms:
